...
public interface RegionRepository extends JpaRepository<Region, Long> {
    @Query(value = "SELECT rg.region_id, rg.region_name, rg.region_boundary FROM region rg WHERE rg.region_name = :region_name", nativeQuery = true)
    public Region findByName(@Param("region_name") String regionName);
    ...
    public Region findRegionContaining(@Param("location") Point loc);
